  ...
  return (
    <div className="component exchange__orders">
      ...
      <form onSubmit={isBuy? buyHandler : sellHandler}>
        ...
        <input type="text" value={amount === 0 ? '' : amount} id="amount" placeholder="0.0000" onChange={(e) => setAmount(e.target.value)}/>
        
        {isBuy? (<label>Buy Price</label>) : (<label>Sell Price</label>)}
        <input type="text" value={price === 0 ? '' : price} id="price" placeholder="0.0000" onChange={(e) => setPrice(e.target.value)}/>
